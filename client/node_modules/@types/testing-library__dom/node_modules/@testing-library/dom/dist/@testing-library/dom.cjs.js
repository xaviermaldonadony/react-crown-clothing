...
var _require = require('./helpers'),
    TEXT_NODE$1 = _require.TEXT_NODE;
...
function getNodeText(node) {
  ...
  return Array.from(node.childNodes).filter(function (child) {
    return child.nodeType === TEXT_NODE$1 && Boolean(child.textContent);
  }).map(function (c) {
...
function queryAllByLabelText(container, text, _temp2) {
  ...
  var matchingLabelledElements = Array.from(container.querySelectorAll('*')).filter(function (element) {
    ...
    var labelsValue = labelsId.length ? labelsId.map(function (labelId) {
      ...
      var formControlSelector = labelledNodeNames.join(',');
      var labelledFormControl = Array.from(label.querySelectorAll(formControlSelector)).filter(function (element) {
